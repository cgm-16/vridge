  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex h-[50px] w-[89px] items-center justify-center gap-[2px] rounded-[80px] bg-white px-[20px] py-[10px] text-[16px] font-medium text-black shadow-[0_0_15px_rgba(255,149,84,0.2)]"
